<template>
  <div class="poli">
    <div class="msxq">
      <div class="xqmap xqmap2">
      <div id="bmap-container" class="zbt" style="width: 800px;height: 240px"></div>
      ...
      local.setSearchCompleteCallback(function(results) {
        if (local.getStatus() == BMAP_STATUS_SUCCESS){
          ...
          for (var i = 0; i < results.getCurrentNumPois(); i ++){
            var item ={number:i+1,title:results.getPoi(i).title, address:results.getPoi(i).address, point:results.getPoi(i).point}
