...
// use for gyt QR
export let startlatLng = '106.650821,26.651954'

export let QRUrl = 'http://qr.liantu.com/api.php?text=';
export let gaodeurl = 'http://uri.amap.com/navigation';
export let serverFmapUrl = 'http://222.85.147.140:10003/interface/map/navigate';
...
export let baiduUrl = 'http://api.map.baidu.com/direction';
